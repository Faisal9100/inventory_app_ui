...
export class SaleService {
  ...
  public url = 'http://192.168.1.9:8000/inventory/sales/';

  public stock_url =
    'http://' + this.ip_address + 'inventory/sales/${purchaseId}/sale_items';
  ...
  public customer_url = 'http:/192.168.1.9:8000/inventory/customers/';
